...
The algorithm is now finished and tested. I represents a big improvement over the original binary version and it scales much better for higher orders. Some features are still work in progress, but for the most part it's done. The algorithm will be summarized for a conference paper and afterwards it will be added to the 'dbnR' package.
